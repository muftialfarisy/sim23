...
<body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="bahann" class="table table-bordered table-hover" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th>No.</th>
                                                <th>Nama Bahan</th>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form name="form" id="form">
                                ...
                                <div class="form-group">
                                    <label>Alasan</label>
                                    <input type="text" class="form-control" placeholder="Alasan" name="alasan" id="alasan">
                                </div>
                                <div class="form-group">
                                    <label>Status</label>
    ...
    <script>
        var readUrl = '<?php echo site_url('ReturBahan_controller/read') ?>';
        var addUrl = '<?php echo site_url('ReturBahan_controller/add') ?>';
        var deleteUrl = '<?php echo site_url('ReturBahan_controller/delete') ?>';
        var editUrl = '<?php echo site_url('ReturBahan_controller/edit') ?>';
        var getBahanUrl = '<?php echo site_url('ReturBahan_controller/get_bahan') ?>';
    </script>
    <script src="<?php echo base_url('assets/js/retur_bahan.js') ?>"></script>
</body>
