...
<body class="hold-transition sidebar-mini layout-fixed">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Tabel Print</h3>
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="print" class="table table-bordered table-hover" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th>No.</th>
                                                <th>Print</th>
                        ...
                        <div class="modal-body">
                            <form name="form" id="form">
                                ...
                                <div class="form-group">
                                    <label>Gambar Desain</label><br>
                                    <img id="v_image" width="300px" height="300px">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" placeholder="Waktu Pengerjaan (satuan menit)" name="waktu_print" id="waktu_print">
                                </div>
                                <input type="hidden" class="form-control" placeholder="status" name="status_print" id="status_print">
                                ...
                                <div class="form-group">
                                    <label>Alasan</label>
                                    <select class="form-control" id="alasan_print" name="alasan_print">
    ...
    <script>
        var readPrintUrl = '<?php echo site_url('Progress_controller/readPrint') ?>';
        var addUrl = '<?php echo site_url('Progress_controller/add') ?>';
        var deleteUrl = '<?php echo site_url('Progress_controller/delete') ?>';
        var editPrintUrl = '<?php echo site_url('Progress_controller/edit_print') ?>';
        var getUserUrl = '<?php echo site_url('Progress_controller/get_user') ?>';
        var getEstimasiUrl = '<?php echo site_url('Progress_controller/get_estimasi_print') ?>';
    </script>
