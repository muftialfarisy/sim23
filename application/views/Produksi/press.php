...
<body class="hold-transition sidebar-mini layout-fixed">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Tabel press</h3>
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="press" class="table table-bordered table-hover" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th>No.</th>
                                                <th>press</th>
                        ...
                        <div class="modal-body">
                            <form name="form" id="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" placeholder="Waktu Pengerjaan (satuan menit)" name="waktu_press" id="waktu_press">
                                </div>
                                <input type="hidden" class="form-control" placeholder="status" name="status_press" id="status_press">
                                ...
                                <div class="form-group">
                                    <label>Alasan</label>
                                    <select class="form-control" id="alasan_press" name="alasan_press">
    ...
    <script src="assets/plugins//datatables-buttons/js/buttons.press.min.js"></script>
    ...
    <script>
        var readPressUrl = '<?php echo site_url('Progress_controller/readPress') ?>';
        var addUrl = '<?php echo site_url('Progress_controller/add') ?>';
        var deleteUrl = '<?php echo site_url('Progress_controller/delete') ?>';
        var editpressUrl = '<?php echo site_url('Progress_controller/edit_press') ?>';
        var getUserUrl = '<?php echo site_url('Progress_controller/get_user') ?>';
        var getEstimasiUrl = '<?php echo site_url('Progress_controller/get_estimasi_press') ?>';
    </script>
    <script src="<?php echo base_url('assets/js/press.js') ?>"></script>
</body>
