...
<body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">jahit</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Tabel jahit</h3>
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="jahit" class="table table-bordered table-hover" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th>No.</th>
                                                <th>jahit</th>
                        ...
                        <div class="modal-body">
                            <form name="form" id="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" placeholder="Waktu Pengerjaan (satuan menit)" name="waktu_jahit" id="waktu_jahit">
                                </div>
                                <input type="text" class="form-control" placeholder="status" name="status_jahit" id="status_jahit">
                                ...
                                <div class="form-group">
                                    <label>Alasan</label>
                                    <select class="form-control" id="alasan_jahit" name="alasan_jahit">
    ...
    <script src="assets/plugins//datatables-buttons/js/buttons.jahit.min.js"></script>
    ...
    <script>
        var readJahitUrl = '<?php echo site_url('Progress_controller/readJahit') ?>';
        var addUrl = '<?php echo site_url('Progress_controller/add') ?>';
        var deleteUrl = '<?php echo site_url('Progress_controller/delete') ?>';
        var editjahitUrl = '<?php echo site_url('Progress_controller/edit_jahit') ?>';
        var getUserUrl = '<?php echo site_url('Progress_controller/get_user') ?>';
        var getEstimasiUrl = '<?php echo site_url('Progress_controller/get_estimasi_jahit') ?>';
    </script>
    <script src="<?php echo base_url('assets/js/jahit.js') ?>"></script>
</body>
