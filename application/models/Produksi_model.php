...
class Produksi_model extends CI_Model
{
    ...
    {
        $this->db->select('produksi.id as idd,produksi.tanggal_order,produksi.no_po,produksi.invoice_po,produksi.customer,produksi.tema_design,produksi.jumlah_pesanan,produksi.produk,produksi.bahan,produksi.jumlah_produk,bahan.id,bahan.nama_bahan as bahann');
