...
function chart(res) {
	...
	var donutData = {
		...
		datasets: [
			{
				data: [desain, print2, cutting, press, jahit, overdeck, obras, qc],
				backgroundColor: [
					"#f56954",
					"#00a65a",
					"#f39c12",
...
function updateProduksi() {
	$.ajax({
		url: tambahProduksiUrl,
		type: "post",
		dataType: "json",
		// data: $("#form").serialize(),
		success: () => {
...
function updatePenggunaanBahan() {
	$.ajax({
		url: tambahPenggunaanBahanUrl,
		type: "post",
		dataType: "json",
		// data: $("#form").serialize(),
		success: () => {
