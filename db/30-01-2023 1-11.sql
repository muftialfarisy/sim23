...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 29, 2023 at 07:11 PM
...
INSERT INTO `pesanan` (`id`, `no_po`, `urutan_order`, `nama_pelanggan`, `tema_desain`, `tanggal_pesanan`, `invoice`, `produk`, `jumlah`, `bahan_baku`, `dateline`, `finishing`, `notifikasi`) VALUES
(10, 6332, 'Order 1', 'bang rachman', '6332_BANG RACHMAN DIKCAB (DONNY-DIAN', '2021-03-01', 'lunas', 'jersey', 159, 'MILANO', '2021-03-07', '5', 0),
(11, 6333, 'Order 2', 'Letda Gani Arta', '6333_PO LETDA GANI ARTA DADU 3121-2 ', '2021-03-01', 'lunas', 'jersey', 68, 'POLYMESS', '2021-03-13', '6', 0),
(12, 6337, 'Order 3', 'ENLISTED', 'ENLISTED', '2021-03-01', 'lunas', 'jersey', 70, 'BILABONG', '2021-03-09', '6', 0),
(13, 6345, 'Order 4', 'Bang Tirta', '6345_PO BANG TIRTA (DONNY)(TOMKET)', '2021-03-02', 'lunas', 'jacket', 90, 'LOTTO', '2021-03-12', '6', 0),
(14, 6342, 'Order 5', 'Bang Andris', '6342_PO BANG ANDRIS_MARINE2_OGI (TOM', '2021-03-02', 'lunas', 'jersey', 8, 'LYCRA', '2021-03-03', '4.05', 0),
(15, 6348, 'Order 6', 'SHARK TEAM', 'SHARK TEAM', '2021-03-02', 'lunas', 'jersey', 70, 'MILANO', '2021-03-09', '3', 0),
(16, 6350, 'Order 7', 'Bang Angga', '6350_PO BANG ANGGA_PASPAMPRESS 3(MAD', '2021-03-03', 'lunas', 'jersey', 9, 'POLYMESS', '2021-03-11', '0', 0),
(17, 6351, 'order 8', 'Bang Iko', '6351_PO BANG IKO(madi)(TOMKET)', '2021-03-03', 'lunas', 'jersey', 2, 'BILABONG', '2021-03-12', '', 1),
(18, 6352, 'order 9', 'bapa agan ', '6352_PO BAPA AGAN_MUTIARA STREET STE', '2021-03-03', 'lunas', 'jersey', 12, 'LYCRA', '2021-03-10', '', 1);
...
INSERT INTO `produksi` (`id`, `id_bahan`, `tanggal_order`, `dateline`, `no_po`, `invoice_po`, `customer`, `tema_design`, `jumlah_pesanan`, `produk`, `bahan`, `jumlah_produk`, `desain`, `print`, `cutting`, `press`, `jahit`, `overdeck`, `obras`, `qc`, `status`, `notifikasi`) VALUES
(19, 2, '2021-03-01', '2021-03-07', 6332, '6332', 'bang rachman', '6332_BANG RACHMAN DIKCAB (DONNY-DIAN)(TOMKET)', 159, 'JERSEY', '2', 159, '100', '12', '12', '12', '12', '12', '12', '12', 'Dikerjakan', 0),
(22, 2, '2021-03-01', '2021-03-13', 6333, 'lunas', 'Letda Gani Arta', '6333_PO LETDA GANI ARTA DADU 3121-2 ', 68, 'jersey', '2', 68, '100', '0', '0', '0', '0', '0', '0', '0', 'Belum Dikerjakan', NULL);
