...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 19, 2023 at 04:07 PM
...
(16, 9, 'Order 1', 9, '30.5', '5.9', '4.8', '1.25', '5.42', '6.2', '8.02', '4.89', '783.87', '839.52', '1654.23'),
(17, 9, 'Order 2', 9, '27.6', '7.3', '3.9', '1.25', '9.6', '5.1', '7.3', '5.51', '335.24', '359.04', '725.12'),
(18, 9, 'Order 3', 9, '34.25', '6.25', '5.7', '1.25', '7.27', '6.15', '5.11', '5.77', '345.1', '369.6', '745.54'),
(20, 9, 'Order 5', 9, '31.35', '8.63', '6.27', '1.25', '8.2', '7', '7.05', '5.65', 'NaN', 'NaN', 'NaN'),
(21, 9, 'Order 6', 9, '25.4', '5.5', '5.73', '1.25', '5.67', '8.32', '8.22', '5.34', '39.44', '369.6', '439.88'),
(22, 9, 'Order 7', 9, '37.5', '4.1', '3.27', '1.25', '6.77', '5.1', '5.43', '4.92', '345.1', '369.6', '745.54'),
(23, 9, 'order 8', 9, '28,55', '7.9', '4.77', '1.25', '8.46', '6.23', '6.1', '5.4', '44.37', '47,52', '122.73'),
(27, 9, 'order 9', 9, '32.82', '6.6', '5.5', '1.25', '5.81', '8.66', '7.12', '4.93', '9.86', '10.56', '51.26'),
...
(8, 'order 8', '3,17\n', '0,63\n', '3,60\n', '4,45\n', '3,31\n', '2021-03-12'),
(9, 'order 9', '18,99\n', '3,75\n', '21,57\n', '26,68\n', '19,83\n', '2021-03-10'),
(20, 'Order 10', '18.976666666', '3.75', '21.573333333', '20.003333333', '20.003333333', '2023-01-30'),
(21, 'order 11', '18.976666666', '3.75', '21.573333333', '20.003333333', '20.003333333', '12');
...
CREATE TABLE `pesanan` (
  ...
  `xs` int(12) DEFAULT NULL,
  `s` int(12) DEFAULT NULL,
  `m` int(12) DEFAULT NULL,
  `l` int(12) DEFAULT NULL,
  `xl` int(12) DEFAULT NULL,
  `xxl` int(12) DEFAULT NULL,
...
INSERT INTO `pesanan` (`id`, `no_po`, `urutan_order`, `nama_pelanggan`, `tema_desain`, `tanggal_pesanan`, `invoice`, `persetujuan`, `produk`, `jumlah`, `xs`, `s`, `m`, `l`, `xl`, `xxl`, `bahan_baku`, `dateline`, `finishing`, `notifikasi`) VALUES
(10, 6332, 'Order 1', 'bang rachman', '6332_BANG RACHMAN DIKCAB (DONNY-DIAN', '2021-03-01', 'lunas', 1, 'jersey', 159, 1, 1, 1, 1, 1, 1, 'MILANO', '2021-03-07', '5', 0),
(11, 6333, 'Order 2', 'Letda Gani Arta', '6333_PO LETDA GANI ARTA DADU 3121-2 ', '2021-03-01', 'lunas', 1, 'jersey', 68, 0, 0, 0, 0, 0, 0, 'POLYMESS', '2021-03-13', '5', 0),
(12, 6337, 'Order 3', 'ENLISTED', 'ENLISTED', '2021-03-01', 'lunas', 1, 'jersey', 70, 0, 0, 0, 0, 0, 0, 'BILABONG', '2021-03-13', '5', 0),
(13, 6345, 'Order 4', 'Bang Tirta', '6345_PO BANG TIRTA (DONNY)(TOMKET)', '2021-03-02', 'lunas', 1, 'jacket', 90, NULL, NULL, NULL, NULL, NULL, NULL, 'LOTTO', '2021-03-12', '6', 0),
(14, 6342, 'Order 5', 'Bang Andris', '6342_PO BANG ANDRIS_MARINE2_OGI (TOM', '2021-03-02', 'lunas', 1, 'jersey', 8, NULL, NULL, NULL, NULL, NULL, NULL, 'LYCRA', '2021-03-03', '4.05', 0),
(15, 6348, 'Order 6', 'SHARK TEAM', 'SHARK TEAM', '2021-03-02', 'lunas', 1, 'jersey', 70, NULL, NULL, NULL, NULL, NULL, NULL, 'MILANO', '2021-03-09', '3', 0),
(16, 6350, 'Order 7', 'Bang Angga', '6350_PO BANG ANGGA_PASPAMPRESS 3(MAD', '2021-03-03', 'lunas', 1, 'jersey', 9, NULL, NULL, NULL, NULL, NULL, NULL, 'POLYMESS', '2021-03-11', '0', 0),
(17, 6351, 'order 8', 'Bang Iko', '6351_PO BANG IKO(madi)(TOMKET)', '2021-03-03', 'lunas', 1, 'jersey', 2, NULL, NULL, NULL, NULL, NULL, NULL, 'BILABONG', '2021-03-12', '', 1),
(18, 6352, 'order 9', 'bapa agan ', '6352_PO BAPA AGAN_MUTIARA STREET STE', '2021-03-03', 'lunas', 1, 'jersey', 12, NULL, NULL, NULL, NULL, NULL, NULL, 'LYCRA', '2021-03-10', '', 1);
...
(8, 'oproduksi', 'oproduksi@mail.c', 'oproduksi', '$2y$10$F.sfHpLkQxvP3MI2MT1PNOtxGfTvFWeMAxafsgZu26zG86H6WAlmq', 'soreang', 'operasional_produksi', 'operasional_produksi'),
